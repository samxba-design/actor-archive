...
const Login = () => {
  ...
  return (
    <AuthLayout quotes={quotes}>
      ...
      <Button variant="outline" className="w-full" onClick={handleGoogleLogin} style={{ borderColor: "hsl(var(--landing-border))", color: "hsl(var(--landing-fg))", background: "transparent" }}>
