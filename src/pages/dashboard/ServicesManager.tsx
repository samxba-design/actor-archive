...
const ServicesManager = () => {
  ...
  return (
    <div className="max-w-3xl space-y-6">
      ...
      {items.length === 0 ? (
        <Card><CardContent className="py-12 text-center text-muted-foreground">No services yet. Add your first service to let visitors know what you offer.</CardContent></Card>
      ) : (
